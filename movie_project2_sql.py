...
movies2 = pandas.read_sql('select director1, director2, domestic, writer1, writer2 from BoxOfficeMojo;', con=con)
con.close()
#print movies2
...
movies2=movies2[movies2['domestic']!='N/A']#remove films with only foreign release
movies2=movies2[movies2['BoxOffice']>0]#remove low boxoffice movies as a test
movies2=movies2[movies2['writer1']!='N/A'] #remove entries with incomplete records
movies2=movies2[movies2['director1']!='N/A'] #remove entries with incomplete records
...
#first find the scores for writer2/director2 (including the dummy "N/A")
...
movies2.ix[movies2.writer2!='N/A', 'writer_score'] =0.5*(movies2['writer_score']+movies2['writer_score2'])
movies2.ix[movies2.director2!='N/A', 'director_score'] =0.5*(movies2['director_score']+movies2['director_score2'])
